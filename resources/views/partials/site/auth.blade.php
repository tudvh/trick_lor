    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <form id="login-form" class="form d-flex flex-column gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="forgot ms-auto">
                                    <button type="button" id="switch-to-forgot">Quên mật khẩu?</button>
                                </div>
                            </div>
                ...
                <!-- Forgot password -->
                <div id="forgot-container" class="d-none">
                    <div class="form-container d-flex flex-column gap-3">
                        <h1 class="title">Quên mật khẩu</h1>
                        <form id="forgot-form" class="form d-flex flex-column gap-4">
                            <div class="form-group">
                                <label for="forgot-email">Email</label>
                                <input type="text" name="forgot_email" id="forgot-email" placeholder="Nhập email của bạn..." required>
                            </div>
