<header>
    <div class="container">
        ...
        <div class="more">
            ...
            @auth('site')
                <div class="btn-group">
                    <button type="button" class="user-avatar dropdown-toggle" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        @php
                        ...
                        <img src="{{ $user->avatar ?? url('assets/img/user-avatar/user-avatar-default.png') }}"
                            alt="{{ $user->full_name }}" title="Tài khoản">
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a href="{{ route('site.profile', ['username' => $user->username]) }}"
                        ...
                        <li>
                            <a href="{{ route('site.my-posts.index') }}"
                                class="dropdown-item d-flex justify-content-center align-items-center gap-3">
                                <div class="icon-box">
                        ...
                        <li>
                            <a href="{{ route('site.activities.view') }}"
                                class="dropdown-item d-flex justify-content-center align-items-center gap-3">
                                <div class="icon-box">
                        ...
                        <li>
                            <a href="{{ route('site.auth.personal') }}"
                                class="dropdown-item d-flex justify-content-center align-items-center gap-3">
                                <div class="icon-box">
            ...
            @else
                <button type="button" class="btn login-btn" data-bs-toggle="modal" data-bs-target="#auth-overlay">Đăng
                    nhập</button>
            @endauth
        </div>
    </div>
