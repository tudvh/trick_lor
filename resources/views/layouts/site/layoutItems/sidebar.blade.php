<aside>
    <ul>
        ...
        <li>
            ...
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3 @if(isset($page) && $language->slug==$page)  active @endif" href="{{ route('site.language',['language'=>$language->slug]) }}">
                <div class="icon-box">
                    {!! $language->icon !!}
                </div>
