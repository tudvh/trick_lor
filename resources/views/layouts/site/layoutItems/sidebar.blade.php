    ...
    <ul>
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3 active" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: orangered" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 576 512">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: rgba(227,76,38,1);" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: rgba(41,101,241,1);" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24">
                        <path d="M5.00055 3L4.35055 6.34H17.9405L17.5005 8.5H3.92055L3.26055 11.83H16.8505L16.0905 15.64L10.6105 17.45L5.86055 15.64L6.19055 14H2.85055L2.06055 18L9.91055 21L18.9605 18L20.1605 11.97L20.4005 10.76L21.9405 3H5.00055Z" />
                    </svg>
                </div>
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: rgba(240,219,79,1);" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: #8993be;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 640 512">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: #4584b6;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 448 512">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: #f89820;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 384 512">
        ...
        <li>
            <a class="d-flex align-items-center flex-column flex-sm-row gap-1 gap-sm-3" href="{{ route('site.home') }}">
                <div class="icon-box">
                    <svg style="color: #f34f29;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 512 512">
