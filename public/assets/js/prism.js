/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+csharp+cpp+graphql+java+javadoclike+json+json5+jsonp+markup-templating+php+phpdoc+php-extras+plsql+powerquery+powershell+python+jsx+tsx+reason+sql+typescript */
var _self =
